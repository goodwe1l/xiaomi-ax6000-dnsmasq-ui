...
function renderDrawer() {
  ...
  const openClass = state.drawer.open ? "open" : "";
  const showBackdrop = state.drawer.open ? "show" : "";
  ...
  return `
    <div class="drawer-backdrop ${showBackdrop}" data-action="close-drawer"></div>
    <aside class="drawer ${openClass}" role="dialog" aria-modal="true">
